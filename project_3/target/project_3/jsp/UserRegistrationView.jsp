...
<head>
	...
	<style type="text/css">
		...
		.p4 {
			background-image: url('<%=ORSView.APP_CONTEXT%>/img/VamanUserRegistrations.jpg');
			background-size: 100%;
			padding-top: 6%;
					...
					<div class="col-md-4 mb-4">
						<div class="card input-group-addon">
							<div class="card-body">
								...
								<h3 class="text-center default-text text-primary pb-2">User Registration</h3>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="defaultForm-email" name="emailId" placeholder="email Id"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="defaultForm-email" maxlength="10" name="mobileNo" placeholder="mobile No"
								...
								<div class="text-center">
									...
									<input type="submit" name="operation" class="btn btn-secondary btn-md" style="font-size: 17px"
