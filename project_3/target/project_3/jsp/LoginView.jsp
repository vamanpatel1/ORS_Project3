...
<head>
	...
	<style type="text/css">	
		...
		.p4 {
			background-image: url('<%=ORSView.APP_CONTEXT%>/img/VamanLogin.jpg');
							...
							<div class="card-body">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control input-group-addon" name="login" placeholder="Enter email"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="password" id="myInput" class="form-control input-group-addon" name="password" placeholder="Enter password" 
								...
								<div class="text-center">
									...
									<input type="submit" name="operation" class="btn btn-success btn-md hover-overlayed" style="font-size: 17px" 
