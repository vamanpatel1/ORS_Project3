...
<head>
	...
	<style>
		.hm {
			background-image: url('<%=ORSView.APP_CONTEXT%>/img/VamanUserList.jpg');
			background-size: 100%;
	...
	<div>
		<form class="pb-5" action="<%=ORSView.USER_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				&emsp;				
				<div class="col-sm-2">
					<input type="text" name="dob" placeholder="Enter dob" id="udate5"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="10%" class="text"><input type="checkbox" id="select_all"
