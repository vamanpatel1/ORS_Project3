...
public class JasperCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {			
			 ...
			 * .compileReport("C:\\Users\\Vaman Patel\\JaspersoftWorkspace\\MyReports\\patel.jrxml"
			 * );
			 */
			
			JasperReport jasperReport = JasperCompileManager.compileReport(rb.getString("jasperreport"));
